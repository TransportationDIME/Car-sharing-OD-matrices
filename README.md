...
This folder gathers the models and data used in -- Anis S., Sacco N. (2024). "Enhancing public transport accessibility: Exploring hybrid car sharing systems for improved connectivity" in , Transportation Engineering, 16, art. no. 100255. -- 
In particualr, there are:
- the CPLEX code implementing the model ,
